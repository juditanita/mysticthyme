...
function Hero() {
  return (
    <>
    <div className='grid mt-4 mb-10 grid-cols-1 md:grid-cols-2 hero-container mx-auto justify-items-center container'>
       ...
       <div className='mt-5 pt-5' >
        ...
        <h1 className='text-4xl md:text-5xl sm:px-6 md:w-6/7   xl:text-7xl lg:w-11/12 font-bold w-7/8 mb-4  '>Welcome to Mystic Thyme Webshop</h1>
        </div>
