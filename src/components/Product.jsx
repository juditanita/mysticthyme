...
function Product() {
  const productElement = products
    .filter((itemCond) => itemCond.price <= 20)
    .map((item) => {
  ...
  return (
    <section className="section container ">
      <h2 className="text-3xl md:text-4xl uppercase font-bold text-center pb-4 mb-8 ">
        Latest Products
      </h2>
      <div className="grid md:grid-cols-2 gap-3 md:gap-5 p-3 mx-auto item-center mt-6">
        {" "}
        {productElement}
      </div>
    </section>
