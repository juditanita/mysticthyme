...
message="Fully booked!"
    ...
    message="only 1 place available"
  }
  else{
    message=`  ${placesAvailable} places available `
  }
  return (
    ...
    {description}
      ...
      <span className="w-2/3 md:col-span-2  col-span-1 px-3 py-4  text-sm font-bold text-gray-700 mr-2 border-2  ">cost: <span className="text-red-800 ">{price}/person</span></span> 
  
    </div>
    <div className='bg-red-200 order-first mx-2 sm:mx-8 md:order-none md:mx-0 col-span-1 md:w-full flex flex-col '>
    <span className="inline-block    text-md py-4 font-semibold text-red-800  "> {message}</span>
